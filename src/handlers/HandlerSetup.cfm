...
<response status="success" type="default">  
	<ide handlerfile="HandlerGenerator.cfm"> 
		<dialog width="700" height="450" title="ColdBox Event Handler Wizard" image="images/ColdBox_Icon.png">  
			...
			<input name="ViewsDirectory" label="Views Directory" type="dir" default="#data.event.ide.projectview.xmlattributes.projectlocation#/views" tooltip="Your views root directory" />
		</dialog>
	</ide>
</response>  
</cfoutput>
