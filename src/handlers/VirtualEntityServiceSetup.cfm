...
<response status="success" type="default">  
	<ide handlerfile="VirtualEntityServiceGenerator.cfm"> 
		<dialog width="600" height="350" title="ColdBox Virtual Entity Service Wizard" image="includes/images/ColdBox_Icon.png">  
			...
			<input name="EventHandling" label="Enable Event Handling" checked="false"  type="boolean" tooltip="Enables the virtual service to announce ColdBox Interception ORM Events" />
